package com.ygy.ad.adsearch.sender.index;

import com.alibaba.fastjson.JSON;
import com.ygy.ad.adcommon.dump.table.*;
import com.ygy.ad.adsearch.handler.AdLevelDataHandler;
import com.ygy.ad.adsearch.index.DataLevel;
import com.ygy.ad.adsearch.index.adunit.AdUnitIndex;
import com.ygy.ad.adsearch.mysql.constant.Constant;
...
public class IndexSender implements ISender {
    ...
    private Logger logger= LoggerFactory.getLogger(IndexSender.class);
    ...
    public void sender(MySqlRowData rowData) {
        ...
        if (DataLevel.LEVEL2.getLevel().equals(level)){
            ...
            logger.error("MysqlRowData ERROR: {}", JSON.toJSONString(rowData));
        }
    }
