...
public class ParseTemplate {
    ...
    public Map<String, TableTemplate> getTableTemplateMap() {
        return tableTemplateMap;
    }

    public void setTableTemplateMap(Map<String, TableTemplate> tableTemplateMap) {
        this.tableTemplateMap = tableTemplateMap;
    }
}
